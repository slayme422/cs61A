...
def balanced(m):
    ...
    left_part_mass=total_mass(left_end)
    right_part_mass=total_mass(right_end)

    left_torque=left_part_mass*length(left_arm)
    right_torque=right_part_mass*length(right_arm)
