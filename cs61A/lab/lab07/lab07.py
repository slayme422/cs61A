...
class Account:
    ...
    def time_to_retire(self, amount):
        ...
        while now_balance<amount:
            now_balance=now_balance+now_balance*self.interest
            years+=1
        return years
...
def without(s, i):
    ...
    else:#i=2 without(Link(3,s.rest)),2)->2ithout(Link(5,s.rest),1)->i=0 without(s.rest,i)
