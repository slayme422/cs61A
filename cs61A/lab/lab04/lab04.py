...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_from_city_a=distance(target, city_a)
    distance_from_city_b=distance(target, city_b)

    if distance_from_city_a>distance_from_city_b:
        return get_name(city_b)
    elif distance_from_city_a < distance_from_city_b:
